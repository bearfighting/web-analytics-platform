...
执行顺序（严格串行；PR0、PR0.5a–e、PR1 contract、PR2 配置持久化、PR3 受保护配置 API、PR4 Collector Ingest Policy Runtime 与 PR5 Capability Runtime 已完成；最近的 migration 与 Analytics E2E 修复后 CI 已全部通过，下一步为 PR6 Dashboard Configuration UI。出口条件和记录见 [Phase 8 Design](phase-8-design.md#26-phase-8-顺序执行计划)）：
