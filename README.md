...
项目已完成 Phase 0 和 Phase 1，Phase 2 当前已完成 Backend API Contract 和 Rust Collector Foundation。
...
真实网络 Transport、Collector ingestion、Storage 和 Dashboard 将按照路线图线性实现，不会在项目启动时一次性创建全部模块。当前 SDK 仍不发起 API request。
